...
class Settings extends Page
{
	...
	static public $quality_small = 0;

	/// Quality of mini thumbnails in overview, scala: 0-100
	static public $quality_mini = 0;


	/**** Admin Settings ****/

	/// Website name
	static public $name 		=	"1-2000";
	...
	/// Folders list
	//private $folders 			=	array('1-100','101-200','201-300','301-400','401-500','501-600','601-700','701-800','801-900');
	...
	static public $rotate_image	=	false;
