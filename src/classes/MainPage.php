...
class MainPage extends Page
{
	...
	public function toHTML(){
		...
		echo "<div id='menu'>\n";
		if(Settings::$rss){
			echo "<span id='rss'><a href='?t=Rss' ".(Settings::$button_title ? "title='".Settings::_("buttons","rss")."'" : "")."><i class='fa fa-rss fa-lg'></i></a></span>";
		}
	...
	//		echo "<div class='bin'><img src='inc/bin.png'>".Settings::_("bin","delete")."</div>";
		...
		echo "</div>\n";
		echo "</div>\n";
		echo "<script src='inc/lazyload.js'></script>\n";
		echo "<script src='inc/ui.js?v=1.0.0.3'></script>\n";
